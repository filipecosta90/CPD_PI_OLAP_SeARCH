...
l = legend(  'Vectorized Sequential Linear Algebra Approach', 'Parallel Linear Algebra Approach' , 'Sequential PostgreSQL', 'Parallel PostgreSQL (max\_parallel\_degree = 20)' );
