...
csv_results_1 = readtable('timings_vec_nomkl_1.csv','ReadVariableNames',true);
csv_results_2 = readtable('timings_vec_nomkl_2.csv','ReadVariableNames',true);
csv_results_4 = readtable('timings_vec_nomkl_4.csv','ReadVariableNames',true);
csv_results_8 = readtable('timings_vec_nomkl_8.csv','ReadVariableNames',true);
csv_results_16 = readtable('timings_vec_nomkl_16.csv','ReadVariableNames',true);
csv_results_32 = readtable('timings_vec_nomkl_32.csv','ReadVariableNames',true);
...
csv_results_1 = readtable('timings_test_1.csv','ReadVariableNames',true);
csv_results_2 = readtable('timings_test_2.csv','ReadVariableNames',true);
csv_results_4 = readtable('timings_test_4.csv','ReadVariableNames',true);
csv_results_8 = readtable('timings_test_8.csv','ReadVariableNames',true);
csv_results_16 = readtable('timings_test_16.csv','ReadVariableNames',true);
csv_results_32 = readtable('timings_test_32.csv','ReadVariableNames',true);
...
seq_pgres_1 = csvread('pgres_seq_1.csv') / 1000;
seq_pgres_2 = csvread('pgres_seq_2.csv') / 1000;
seq_pgres_4 = csvread('pgres_seq_4.csv') / 1000;
seq_pgres_8 = csvread('pgres_seq_8.csv') / 1000;
seq_pgres_16 = csvread('pgres_seq_16.csv') / 1000;
seq_pgres_32 = csvread('pgres_seq_32.csv') / 1000;
...
par_pgres_1 = csvread('query_3/pgres_par_query_3_1.csv') / 1000;
par_pgres_2 = csvread('query_3/pgres_par_query_3_2.csv') / 1000;
par_pgres_4 = csvread('query_3/pgres_par_query_3_4.csv') / 1000;
par_pgres_8 = csvread('query_3/pgres_par_query_3_8.csv') / 1000;
par_pgres_16 = csvread('query_3/pgres_par_query_3_16.csv') / 1000;
par_pgres_32 = csvread('query_3/pgres_par_query_3_32.csv') / 1000;
...
l = legend( 'Parallel PostgreSQL (max\_parallel\_degree = 20)' );
%'Vectorized Sequential Linear Algebra Approach',  'Parallel Linear Algebra Approach' , 'Parallel Linear Algebra Approach New Version',  'Sequential PostgreSQL', 
...
t = title({'TPC-H benchmark query-3 time for solution analysis','for different scale factors, between Linear Algebra approach vs Relational Algebra approach,', 'performing a K-Best (K=3,N=50) time measurement technique'},'interpreter','latex');
set(gca,'fontsize',12);
